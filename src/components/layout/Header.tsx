...
const navLinks = [
  {
    ...
    label: 'Inverno',
    submenu: [
      { href: '/secao/inverno', label: 'Ver coleção inverno' },
      { href: '/secao/inverno', label: 'Casacos e jaquetas' },
      { href: '/secao/inverno', label: 'Moletons' },
      { href: '/secao/inverno', label: 'Tricôs e cardigãs' },
    ],
  },
  {
    href: '/secao/masculino',
    label: 'Masculino',
    submenu: [
      { href: '/secao/masculino', label: 'Ver tudo masculino' },
      { href: '/secao/masculino', label: 'Camisetas' },
      { href: '/secao/masculino', label: 'Calças' },
      { href: '/secao/masculino', label: 'Jaquetas' },
    ],
  },
  {
    href: '/secao/feminino',
    label: 'Feminino',
    submenu: [
      { href: '/secao/feminino', label: 'Ver tudo feminino' },
      { href: '/secao/feminino', label: 'Vestidos' },
      { href: '/secao/feminino', label: 'Blusas' },
      { href: '/secao/feminino', label: 'Calças' },
    ],
  },
  {
    href: '/secao/acessorios',
    label: 'Acessórios',
    submenu: [
      { href: '/secao/acessorios', label: 'Ver tudo de Acessórios' },
      { href: '/secao/acessorios', label: 'Bolsas' },
      { href: '/secao/acessorios', label: 'Cintos' },
      { href: '/secao/acessorios', label: 'Óculos' },
      { href: '/secao/acessorios', label: 'Chapéus' },
    ],
  },
  {
    href: '/secao/tecnologia',
    label: 'Tecnologia',
    submenu: [
      { href: '/secao/tecnologia', label: 'Ver tudo de Tecnologia' },
      { href: '/secao/tecnologia', label: 'Tecidos inteligentes' },
      { href: '/secao/tecnologia', label: 'Térmicos' },
      { href: '/secao/tecnologia', label: 'Impermeáveis' },
    ],
  },
  {
    href: '/secao/novidades',
    label: 'Novidades',
    submenu: [
      { href: '/secao/novidades', label: 'Recém chegados' },
      { href: '/secao/novidades', label: 'Coming Soon' },
      { href: '/secao/novidades', label: 'Edições limitadas' },
    ],
  },
]
